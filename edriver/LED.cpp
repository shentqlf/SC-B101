...
void LED::show_date_time(u8 *buf)
{
	...
	//显示年
		led_buf[i++] = led_table_a[(buf[5+6])-0x30];
		led_buf[i++] = led_table_a[(buf[4+6])-0x30];
		led_buf[i++] = led_table_a[(buf[3+6])-0x30];
		led_buf[i++] = led_table_a[(buf[2+6])-0x30];
		led_buf[i++] = led_table_a[(buf[1+6])-0x30];
		led_buf[i++] = led_table_a[(buf[0+6])-0x30];
	//时分秒
